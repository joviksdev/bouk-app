		...
		<div style={{ backgroundColor: '#fff' }}>
			...
			>
				<Overlay>
					<HeaderTextContainer>
						<h1>
							Join the Bouk community and
							<br /> see your business grow with us
						</h1>

						<span>
							People are ordering online more than ever. Be where they are and
							extend your
							<br /> reach, make more sales, and grow your business by
			...
			<Container>
				<ServiceSection>
					...
					<Customers>
						...
						<ImageContainer>
							<img alt={'boukad'} style={{ width: '70%' }} src={SupportImage} />
						</ImageContainer>
					</Customers>
				</ServiceSection>
			</Container>
